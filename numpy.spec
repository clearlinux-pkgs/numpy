...
%prep
%setup -q -n numpy-1.21.0
cd %{_builddir}/numpy-1.21.0
%patch1 -p1
%patch2 -p1
%patch3 -p1
%patch5 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1624479267
...
cp %{_builddir}/numpy-1.21.0/LICENSE.txt %{buildroot}/usr/share/package-licenses/numpy/142c59550ceb3a55dc6619d03b5f930956eeaa25
cp %{_builddir}/numpy-1.21.0/doc/source/_static/scipy-mathjax/LICENSE %{buildroot}/usr/share/package-licenses/numpy/2b8b815229aa8a61e483fb4ba0588b8b6c491890
cp %{_builddir}/numpy-1.21.0/numpy/core/include/numpy/libdivide/LICENSE.txt %{buildroot}/usr/share/package-licenses/numpy/c474367bace9239be97704a6272681c4c22ed9f6
cp %{_builddir}/numpy-1.21.0/numpy/linalg/lapack_lite/LICENSE.txt %{buildroot}/usr/share/package-licenses/numpy/3ddf920aa10c8c6ea0c87d218af74651ea7d16d3
cp %{_builddir}/numpy-1.21.0/numpy/ma/LICENSE %{buildroot}/usr/share/package-licenses/numpy/85f84e10061f078b2cfaa62239c3a4bde1355f34
cp %{_builddir}/numpy-1.21.0/numpy/random/LICENSE.md %{buildroot}/usr/share/package-licenses/numpy/64796c34e3592909154742074f735b89171a4418
cp %{_builddir}/numpy-1.21.0/numpy/random/src/distributions/LICENSE.md %{buildroot}/usr/share/package-licenses/numpy/df1c41ca8a294222a81f70a142832d6566fbd889
cp %{_builddir}/numpy-1.21.0/numpy/random/src/mt19937/LICENSE.md %{buildroot}/usr/share/package-licenses/numpy/50faca55f553c4ecd9f20c020176ca65324d3604
cp %{_builddir}/numpy-1.21.0/numpy/random/src/pcg64/LICENSE.md %{buildroot}/usr/share/package-licenses/numpy/752f3cb872e3c7a6e096746e3648acaf2e065c96
cp %{_builddir}/numpy-1.21.0/numpy/random/src/philox/LICENSE.md %{buildroot}/usr/share/package-licenses/numpy/c107ade2df71a8954740468bbaa8b15e0ef4cb8b
cp %{_builddir}/numpy-1.21.0/numpy/random/src/sfc64/LICENSE.md %{buildroot}/usr/share/package-licenses/numpy/1e0aa0638753b29e98ff682cff77d40ee4700250
cp %{_builddir}/numpy-1.21.0/tools/npy_tempita/license.txt %{buildroot}/usr/share/package-licenses/numpy/f853f54fdd704c7d99fc6eb5c8e895f3a7764f08
