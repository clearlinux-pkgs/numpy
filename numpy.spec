...
Source0  : https://files.pythonhosted.org/packages/2c/2f/7b4d0b639a42636362827e611cfeba67975ec875ae036dd846d459d52652/numpy-1.19.1.zip
...
%prep
%setup -q -n numpy-1.19.1
cd %{_builddir}/numpy-1.19.1
%patch1 -p1
%patch2 -p1
%patch3 -p1
%patch5 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1595459779
...
cp %{_builddir}/numpy-1.19.1/doc/scipy-sphinx-theme/LICENSE.txt %{buildroot}/usr/share/package-licenses/numpy/fd2e79f66abba5b94347c2df9ca6cf3584b0c517
cp %{_builddir}/numpy-1.19.1/doc/source/license.rst %{buildroot}/usr/share/package-licenses/numpy/341dccd98f25cfc90429aa52a5639159a574a0bf
cp %{_builddir}/numpy-1.19.1/doc/sphinxext/LICENSE.txt %{buildroot}/usr/share/package-licenses/numpy/df4f727b25238b8a4be050714fe3f1cb06b17f75
cp %{_builddir}/numpy-1.19.1/numpy/linalg/lapack_lite/LICENSE.txt %{buildroot}/usr/share/package-licenses/numpy/3ddf920aa10c8c6ea0c87d218af74651ea7d16d3
cp %{_builddir}/numpy-1.19.1/numpy/ma/LICENSE %{buildroot}/usr/share/package-licenses/numpy/85f84e10061f078b2cfaa62239c3a4bde1355f34
cp %{_builddir}/numpy-1.19.1/numpy/random/LICENSE.md %{buildroot}/usr/share/package-licenses/numpy/64796c34e3592909154742074f735b89171a4418
cp %{_builddir}/numpy-1.19.1/numpy/random/src/distributions/LICENSE.md %{buildroot}/usr/share/package-licenses/numpy/df1c41ca8a294222a81f70a142832d6566fbd889
cp %{_builddir}/numpy-1.19.1/numpy/random/src/mt19937/LICENSE.md %{buildroot}/usr/share/package-licenses/numpy/50faca55f553c4ecd9f20c020176ca65324d3604
cp %{_builddir}/numpy-1.19.1/numpy/random/src/pcg64/LICENSE.md %{buildroot}/usr/share/package-licenses/numpy/752f3cb872e3c7a6e096746e3648acaf2e065c96
cp %{_builddir}/numpy-1.19.1/numpy/random/src/philox/LICENSE.md %{buildroot}/usr/share/package-licenses/numpy/c107ade2df71a8954740468bbaa8b15e0ef4cb8b
cp %{_builddir}/numpy-1.19.1/numpy/random/src/sfc64/LICENSE.md %{buildroot}/usr/share/package-licenses/numpy/1e0aa0638753b29e98ff682cff77d40ee4700250
cp %{_builddir}/numpy-1.19.1/tools/npy_tempita/license.txt %{buildroot}/usr/share/package-licenses/numpy/f853f54fdd704c7d99fc6eb5c8e895f3a7764f08
